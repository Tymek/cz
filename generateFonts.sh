...
woff2_compress /tmp/playfair-display/PlayfairDisplay-Italic-VariableFont_wght.ttf
cp /tmp/spartan/Spartan-VariableFont_wght.woff2 ./public/fonts/spartan.woff2
cp /tmp/playfair-display/PlayfairDisplay-Italic-VariableFont_wght.woff2 ./public/fonts/playfair-display.woff2
cp /tmp/playfair-display/PlayfairDisplay-Italic-VariableFont_wght.woff2 ./public/fonts/playfair-display-italic.woff2
